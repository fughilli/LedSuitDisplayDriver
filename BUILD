...
cc_binary(
    ...
    deps = ["@org_llvm_libcxx//:libcxx"],
    data = ["//tools/cc_toolchain/raspberry_pi_sysroot:everything"],
    copts = ["-isystem", "external/raspberry_pi/sysroot/opt/vc/include", "-isystem", "external/raspberry_pi/sysroot/opt/vc/include/interface/vcos/pthreads", "-isystem", "external/raspberry_pi/sysroot/opt/vc/include/interface/vmcs_host/linux"],
    linkopts = ["-Lexternal/raspberry_pi/sysroot/opt/vc/lib", "-lbcm_host"],
    linkstatic = 1,
)
